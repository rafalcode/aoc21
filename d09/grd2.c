...
av_c *crea_avc(int vbf)
{
    ...
    avc->vbf=vbf;
    avc->x=malloc(avc->vbf*sizeof(int));
    avc->y=malloc(avc->vbf*sizeof(int));
    avc->vsz=0;
    return avc;
}
...
void glow0(aaw_c *aawc) /* print line and word details, but not the words themselves */
{
    int i, j, k;
    int sz;
    int *a=malloc(4*sizeof(int));
    int bsz[3]={0}, n=0, su=0;
